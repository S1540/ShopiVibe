        ...
        <div className="relative">
          ...
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-row items-center gap-4 z-50 md:top-1/2 md:left-8 md:-translate-y-1/2 md:translate-x-0 md:flex-col">
            ...
            <div className="social-button">
              <button className="relative w-12 h-12 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:left-10 group-hover:shadow-2xl cursor-pointer md:group-hover:left-10"></div>
            ...
            <div className="social-button">
              <button className="relative w-12 h-12 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:left-10 group-hover:shadow-2xl cursor-pointer md:group-hover:left-10 "></div>
            ...
            <div className="social-button">
              <button className="relative w-12 h-12 rounded-full group">
                <div className="floater w-full h-full absolute top-0 left-0 bg-red-600 rounded-full duration-300 group-hover:left-10 group-hover:shadow-2xl cursor-pointer md:group-hover:left-10 "></div>
