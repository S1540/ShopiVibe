...
const HeroSec = () => {
  return (
    <>
      <section className="max-w-full relative top-15 bg-gradient-to-r from-purple-400 via-zinc-300 to-purple-400  py-1 md:py-13 lg:py-17 overflow-hidden h-[600px]">
        {/* left Area */}
        <div>
          <div
          ...
          >
            <div class="social-button ">
              <button class="relative w-12 h-12 rounded-full group">
                <div class="floater w-full h-full absolute top-0 left-0 bg-red-500 rounded-full duration-300 group-hover:left-10 group-hover:shadow-2xl"></div>
            ...
            <div class="social-button">
              <button class="relative w-12 h-12 rounded-full group">
                <div class="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:left-10 group-hover:shadow-2xl cursor-pointer"></div>
            ...
            <div class="social-button">
              <button class="relative w-12 h-12 rounded-full group">
                <div class="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:left-10 group-hover:shadow-2xl cursor-pointer"></div>
            ...
            <div class="social-button">
              <button class="relative w-12 h-12 rounded-full group">
                <div class="floater w-full h-full absolute top-0 left-0 bg-red-600 rounded-full duration-300 group-hover:left-10 group-hover:shadow-2xl cursor-pointer"></div>
                <div class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-700 rounded-full">
                  <svg
                    fill="none"
                    viewBox="0 0 30 22"
                    height="22"
        ...
        <div className="max-w-full flex justify-center">
          <div className="max-w-md w-full flex flex-col justify-center items-center gap-5 py-10 md:py-20">
            <h1 className="text-6xl text-center font-medium tracking-widest">
              WELCOME TO
            </h1>
