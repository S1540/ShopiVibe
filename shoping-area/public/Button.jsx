...
const Button = ({ button }) => {
  return (
    <>
      <button className="relative max-w-44 w-full inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-indigo-600 rounded-md group">
